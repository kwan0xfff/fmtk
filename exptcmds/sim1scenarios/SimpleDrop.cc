...
#define STATEMAX        2
class SimpleDrop : public Scenario {
  protected:
  ...
  public:
    ...
    const char* getName() { return "SimpleDrop"; }
...
//  Moderate accuracy is provided at 0.1 second. Try 1.0 or 0.02 for more
//  interesting results.
//
void
SimpleDrop::initcond()
...
unsigned int
SimpleDrop::putnow(unsigned int forcemask)
{
...
// class factories
extern "C" Scenario* create() { return new SimpleDrop; }
